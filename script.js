...
function handleDrop(evt) {
    ...
    let sourceListId = evt.dataTransfer.getData("sourceListId");

    let targetList = evt.target;
...
function deleteTask(evt) {
    ...
    let taskToDeleteId = evt.target.parentNode.id;
...
function removeTask(taskID) {
    ...
    let parentList = taskElement.parentNode;
